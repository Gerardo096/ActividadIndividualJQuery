...
function ocultarForm(event) {
    ...
    if (document.getElementById("nombre1").value == "" || document.getElementById("nombre2").value == "") {
        ...
        //he considerado que esto ya seria parte del efecto que hay que añadir
...
function comprobarCasilla(img) {
    //No he conseguido hacer que la partida salte en el ultimo click por lo que hay que dar 1 click mas T_T
